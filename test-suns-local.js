...
console.log('Testing Suns Cinema scraper with local HTML...\n');

const html = fs.readFileSync('suns-raw.html', 'utf8');
...
console.log('All screenings:');
screenings.forEach((s, i) => {
  console.log(`${i + 1}. ${s.title}`);
  console.log(`   Date: ${s.date} at ${s.time}`);
  console.log(`   Link: ${s.ticketLink}`);
  console.log(`   Poster: ${s.poster ? s.poster.substring(0, 50) + '...' : 'No'}\n`);
});
